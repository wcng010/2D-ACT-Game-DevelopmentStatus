...
namespace C_Script.Eneny.Boss.SwordSaint
{
    ...
    public class SwordSaintData : BossData
    {
        ...
        public Vector2 Attack1Direction = new Vector2(Mathf.Cos(75),Mathf.Sin(75));
        public Vector2 Attack2Direction = new Vector2(Mathf.Sin(-75), Mathf.Cos(-75));
        public Vector2 Attack3Direction = new Vector2(1, 0);
    }
}